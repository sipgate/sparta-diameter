...
public class RxAvpSpecTest extends AvpSpecTestBase {

    private static final Set<AvpDef> AVP_DEFS = loadAvpDefs("/rx-avps.json");
    private static final Collection<AVPDefinition> DEFINITIONS = new RxAVPProvider().getDefinitions();
    ...
    protected String mixinsPackage() {
        return "com.sipgate.sparta.diameter._3gpp.rx.mixins";
    }
