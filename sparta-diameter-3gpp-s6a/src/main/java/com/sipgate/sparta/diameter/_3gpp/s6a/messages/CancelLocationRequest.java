...
/**
 * Cancel-Location-Request (CLR) — 3GPP TS 29.272 §7.2.7. HSS-initiated.
 */
public interface CancelLocationRequest
        extends _3gppRequest,
                ...
                HasCancellationTypeAVP, HasClrFlagsAVP,
                HasProxyInfoAVPs, HasRouteRecordAVPs {

    final class In extends IncomingRequest<CancelLocationAnswer.Out>
            implements CancelLocationRequest {

        In(final HopByHopId hopByHop, final EndToEndId endToEnd, final boolean retransmitted) {
            super(S6aConstants.CMD_CANCEL_LOCATION, true, retransmitted,
                  S6aConstants.APP_ID_S6A_S6D, hopByHop, endToEnd);
        }
    }

    final class Out extends OutgoingRequest<CancelLocationAnswer.In>
            implements CancelLocationRequest {
