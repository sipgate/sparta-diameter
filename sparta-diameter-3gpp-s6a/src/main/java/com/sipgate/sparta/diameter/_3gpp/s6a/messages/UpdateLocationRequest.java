...
import com.sipgate.sparta.diameter._3gpp.common.mixins.HasRatTypeAVP;
...
/**
 * Update-Location-Request (ULR) — 3GPP TS 29.272 §7.2.3.
 */
public interface UpdateLocationRequest
        extends _3gppRequest,
                ...
                HasTerminalInformationAVP, HasRatTypeAVP,
                HasUlrFlagsAVP, HasUeSrvccCapabilityAVP, HasVisitedPlmnIdAVP,
                HasProxyInfoAVPs, HasRouteRecordAVPs {

    final class In extends IncomingRequest<UpdateLocationAnswer.Out>
            implements UpdateLocationRequest {

        In(final HopByHopId hopByHop, final EndToEndId endToEnd, final boolean retransmitted) {
            super(S6aConstants.CMD_UPDATE_LOCATION, true, retransmitted,
                  S6aConstants.APP_ID_S6A_S6D, hopByHop, endToEnd);
        }
    }

    final class Out extends OutgoingRequest<UpdateLocationAnswer.In>
            implements UpdateLocationRequest {
