...
/** Update-Location-Request/Answer (Answer) (ULA) — 3GPP TS 29.272 §7.2.3-4. */
public interface UpdateLocationAnswer
        extends _3gppAnswer,
                HasDrmpAVP, HasErrorDiagnosticAVP, HasOcSupportedFeaturesAVP, HasOcOlrAVP, HasLoadAVPs, HasSupportedFeaturesAVPs, HasUlaFlagsAVP, HasSubscriptionDataAVP, HasResetIdAVPs, HasRouteRecordAVPs {

    final class In extends IncomingAnswer implements UpdateLocationAnswer {
        In(final HopByHopId hopByHop, final EndToEndId endToEnd) {
            super(S6aConstants.CMD_UPDATE_LOCATION, true, S6aConstants.APP_ID_S6A_S6D, hopByHop, endToEnd);
        }
    }

    final class Out extends OutgoingAnswer implements UpdateLocationAnswer {
