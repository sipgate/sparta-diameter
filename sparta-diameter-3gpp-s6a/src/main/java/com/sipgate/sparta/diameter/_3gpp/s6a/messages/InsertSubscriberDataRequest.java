...
/**
 * Insert-Subscriber-Data-Request (IDR) — 3GPP TS 29.272 §7.2.9. HSS-initiated.
 */
public interface InsertSubscriberDataRequest
        extends _3gppRequest,
                ...
                HasSubscriptionDataAVP, HasIdrFlagsAVP,
                HasProxyInfoAVPs, HasRouteRecordAVPs {

    final class In extends IncomingRequest<InsertSubscriberDataAnswer.Out>
            implements InsertSubscriberDataRequest {

        In(final HopByHopId hopByHop, final EndToEndId endToEnd, final boolean retransmitted) {
            super(S6aConstants.CMD_INSERT_SUBSCRIBER_DATA, true, retransmitted,
                  S6aConstants.APP_ID_S6A_S6D, hopByHop, endToEnd);
        }
    }

    final class Out extends OutgoingRequest<InsertSubscriberDataAnswer.In>
            implements InsertSubscriberDataRequest {
