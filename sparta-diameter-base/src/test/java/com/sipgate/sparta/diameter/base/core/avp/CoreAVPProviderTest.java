...
class CoreAVPProviderTest {
    ...
    void it_has_a_definition_for_every_avp_constant() throws IllegalAccessException {
        ...
        for (final var field : DiameterConstants.class.getDeclaredFields()) {
        ...
        // THEN
        assertThat(missing)
            .as("AVP_* constants in DiameterConstants without a definition in CoreAVPProvider")
            .isEmpty();
    }
}
