...
public class GxAvpSpecTest extends AvpSpecTestBase {

    private static final Set<AvpDef> AVP_DEFS = loadAvpDefs("/gx-avps.json");
    private static final Collection<AVPDefinition> DEFINITIONS = new GxAVPProvider().getDefinitions();
    ...
    protected String mixinsPackage() {
        return "com.sipgate.sparta.diameter._3gpp.gx.mixins";
    }
